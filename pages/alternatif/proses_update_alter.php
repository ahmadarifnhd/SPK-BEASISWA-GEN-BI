<?php  
    ...
    $query = "UPDATE data_alternatif SET Nama_Mahasiswa = '$namaAlternatif', 
		Jenis_Beasiswa = '$jenisMenu' WHERE ID_Alternatif = '$idAlter'";
      ...
      <div class="card-body">
        <form role="form" method="post">
            ...
            <select class="form-control select2" style="width: 100%;" name="jenis" required>
              <option value="GenBi" <?= $hasil['Jenis_Beasiswa'] == 'GenBi' ? 'selected' : '' ?>>GenBi</option>
              <option value="Merdeka" <?= $hasil['Jenis_Beasiswa'] == 'Merdeka' ? 'selected' : '' ?>>Merdeka</option>
            </select>
          </div>
