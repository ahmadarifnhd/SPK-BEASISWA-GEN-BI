            ...
            <div class="card-body">
                <form role="form" method="post">
                    ...
                    <div class="simpan text-right">
                        <button type="submit" class="btn btn-primary" name="simpan" id="simpan"><i
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr class="text-center">
                                            <td class="text-nowrap"><?= $items['AO']; ?></td>
                                            <td class="text-nowrap"><?= $items['IPK']; ?></td>
                                            <td class="text-nowrap"><?= $items['KKM']; ?></td>
                                            <td class="text-nowrap"><?= $items['TMB']; ?></td>
                                            <td class="text-nowrap"><?= $items['SMT']; ?></td>
                                            <td class="text-nowrap">
                                                <center>
                                                    <a
                                                        href="index.php?page=delete_kriteria&id=<?= $items['ID_Kriteria']; ?>">
                                                        <button type="button" class="btn btn-primary"
                                                            onclick="return confirm('Hapus nilai bobot?');"><i
